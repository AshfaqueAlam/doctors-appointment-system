...
<?php 
 ...
 ?>
	...
	<!-- 	booking info-->
		...
		<h2 class="text">Book Appoinment</h2>
			<div class="formstyle" style="float: right;padding:20px;border: 1px solid lightgrey;margin-right:40%; margin-bottom:30px;background-color:#f3f3f8;color:#141313; margin-top:20px; " >
				<form action="" method="post" class="text-center form-group" enctype="multipath/form-data">
					...
					<label>
						Fee(INR): <input type="text" name="fee" value="<?php echo $fee; ?>" >
					</label><br><br>
					<label>
